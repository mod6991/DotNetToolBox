...
namespace DotNetToolBox.UnitTests
{
    ...
    public class ChaCha20Tests
    {
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
            @"|DataDirectory|\data\chacha20.csv", "chacha20#csv", DataAccessMethod.Sequential)]
        public void Encrypt_Tests()
        {
            ...
            byte[] enc = ChaCha20.Encrypt(data, key, nonce);
        ...
        public void Encrypt_Stream_Tests()
        {
            ...
            using(MemoryStream msIn = new MemoryStream(data))
            {
                ...
                {
                    ChaCha20.Encrypt(msIn, msOut, key, nonce);
                    enc = msOut.ToArray();
                }
            }
        ...
        public void Decrypt_Tests()
        {
            ...
            byte[] dec = ChaCha20.Decrypt(enc, key, nonce);
        ...
        public void Decrypt_Stream_Tests()
        {
            ...
            using(MemoryStream msIn = new MemoryStream(enc))
            {
                using (MemoryStream msOut = new MemoryStream())
                {
                    ChaCha20.Decrypt(msIn, msOut, key, nonce);
                    dec = msOut.ToArray();
                }
            }
